...
var_dump($_GET);
// renvoie un params p qui vient de notre htaccess
...
// permet d'accéder au controler, à la classe
$called = 'controllers/'.$controller.'.php' ;
require($called);


// => manque method pour mettre en Maj la premiere lettre de controler pour correspondre au nom de la classe


// on vérifie bien que la methode appellée existe dans la classe
if ( method_exists( $controller , $method )) {
  // on l'execute
  $myctrl = new $controller() ; // $myctrl = new Tuto(); instancie a partir d'une variable
  $myctrl->$method(); // $myctrl->index(); appel ma methed
  // tuto->index()
}
else {
